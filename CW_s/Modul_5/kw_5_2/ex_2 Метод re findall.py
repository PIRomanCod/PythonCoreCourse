...
string = "Нільс Бор народився в родині 11 професора фізіології Копенгагенського університету Християна Бора (1858—1911), "\
...
# Знайти всі цифри і їх к-сть
result = re.findall(r'\d', string)
print(result)
print(len(result))

# Знайти всі числа і їх к-сть
# result = re.findall(r'\d+', string)
