'''
Метод: compile
Ми використали функцію compile щоб скомпілювати попередньо створений патерн. Потрібно, якщо
...
string = "Нільс Бор народився в родині професора фізіології Копенгагенського університету Християна Бора (1858—1911), "\
         ...
         "із британської єврейської банкірської династії Raphael Raphael & sons[en][7] years. А тепер."
...
print(result)
# Знайти всі слова
pattern = re.compile(r"\w+")  # Шукати всі символи крі пробілів, дужок і т.д.
result = pattern.findall(string)
print(result)
